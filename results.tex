...
\begin{tabular}{crrrrrrrrrr}
    ...
    \multicolumn{1}{l}{Cellpose} & 3.6  & 0.217 & 0.214 & 0.212 & 0.210 & 0.203& 0.197& 0.183 & 0.146 &0.042\\
     \multicolumn{1}{l}{StarDist-3D} & 20     & \underline{0.988} &	\underline{0.982} & 	\underline{0.982} & 	\textbf{0.982} & 	\underline{0.973} & 	\underline{0.970} & 	\underline{0.958} & 	\underline{0.774} & 	\underline{0.052} \\
    %  \rowcolor{Gray}
    \multicolumn{1}{l}{Ours} & 7  & \textbf{0.990} & \textbf{0.984} &  \textbf{0.984} & \underline{0.980} & \textbf{0.975} & \textbf{0.975} & \textbf{0.973} & \textbf{0.970} & \textbf{0.928} \\ \midrule
   %
   \multicolumn{11}{c}{\textit{Platynereis-2020}} \\ \midrule
    \multicolumn{1}{l}{Cellpose} & 3.6 & \underline{0.971} & 	\textbf{0.971} &	\underline{0.966} & 	0.957 & 	0.931 & 	0.872 & 	0.700 &	\underline{0.299} & 	\textbf{0.009}\\
     \multicolumn{1}{l}{StarDist-3D} & 20     & \textbf{0.973} & \underline{0.969} &0.966 & \underline{0.966} & \underline{0.937} & \textbf{0.910} & \textbf{0.736} & 0.246 & 0.002\\
    %  \rowcolor{Gray}
    \multicolumn{1}{l}{Ours} &  7 & 0.969 & \underline{0.969} &  \textbf{0.968} & \underline{0.962} & \textbf{0.947} &   \underline{0.889} & \underline{0.735} & \textbf{0.333} & \underline{0.007}\\ \midrule
    \multicolumn{11}{c}{\textit{Parhyale-2016}} \\ \midrule
    \multicolumn{1}{l}{Cellpose} & 3.6 & 0.545 &  	0.498 & 0.456 & 0.384 & 0.285 & 0.154 & 0.040 & 0.006 &  0.000 \\
    \multicolumn{1}{l}{U-Net} &  & 0.547 & 0.501 & 0.423 &   0.330 &  0.247 &  0.171 &  0.091 &  0.021 &   0.000 \\
     \multicolumn{1}{l}{StarDist-3D} & 20     & \textbf{0.766} &   \textbf{0.757} &  \textbf{0.741} &  \textbf{0.698} &  \textbf{0.593} &  \textbf{0.443} &  \textbf{0.224} &  \underline{0.038} & 0.000 \\
    %  \rowcolor{Gray}
    \multicolumn{1}{l}{Ours} & 7  & \underline{0.701} &	\underline{0.689} 	& \underline{0.678} & 	\underline{0.612} & 	\underline{0.509} & 	\underline{0.371} &	\underline{0.191} & 	\textbf{0.043} &	0.000        \\ 
    \bottomrule
\end{tabular}
\end{table*}
}
